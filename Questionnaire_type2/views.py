...
def common_features_test_block_display_stimuli_type3(request):
    if request.method=="POST":
        ...
        if request.session['setnumber'] == 0:
            ...
            common_feature.file_name = "NoColorCue_type2/set0" + request.session['file_name']
        elif request.session['setnumber'] == 1:
            ...
            common_feature.file_name = "NoColorCue_type2/set1" + request.session['file_name']
        elif request.session['setnumber'] == 2:
            ...
            common_feature.file_name = "NoColorCue_type2/set2" + request.session['file_name']
        elif request.session['setnumber'] == 3:
            ...
            common_feature.file_name = "NoColorCue_type2/set3" + request.session['file_name']
        elif request.session['setnumber'] == 4:
            ...
            common_feature.file_name = "NoColorCue_type2/set4" + request.session['file_name']
