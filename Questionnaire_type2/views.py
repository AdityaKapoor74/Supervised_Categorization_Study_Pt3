...
def classify_and_learn_type3(request):
    return render(request, 'Questionnaire_type2/classify_and_learn.html',
...
def classify_and_learn_display_stimuli_type3(request):
    if request.method=="POST":
        ...
        if option==request.session['correct_answer']:
            ...
            return render(request, "Questionnaire_type2/correct_ans_classify.html",{'time_taken':round(request.session['elapsed_time'],2)})
        else:
...
def test_phase_type3(request):
    return render(request,"Questionnaire_type2/test_phase_instructions.html")

def test_block_type3(request):
    return render(request,"Questionnaire_type2/test_block.html",{"iteration":request.session['test_iteration']})
...
def test_block_display_stimuli_type3(request):
    if request.method=="POST":
        ...
        if request.session['setnumber'] == 0:
            ...
            transfer_stimuli.file_name = "NoColorCue_type3/set0/"+request.session['file_name']
            ...
            transfer_stimuli.file_name = "NoColorCue_type3/set1" + request.session['file_name']
            ...
            transfer_stimuli.file_name = "NoColorCue_type3/set2" + request.session['file_name']
            ...
            transfer_stimuli.file_name = "NoColorCue_type3/set3" + request.session['file_name']
            ...
            transfer_stimuli.file_name = "NoColorCue_type3/set4" + request.session['file_name']
        ...
        return render(request,"Questionnaire_type2/selected_category_test.html",{"option":option, "timetaken":round(request.session['elapsed_time'],2)})
    ...
    if len(request.session['test_samples'])!=0:
        ...
        return render(request, 'Questionnaire_type2/test_samples.html',{'samples':samples})

    else:
        if request.session['test_phase_flag'] == True and request.session['test_iteration']<4:
            request.session['test_phase_flag'] = False
            return render(request, "Questionnaire_type2/break.html")
        if request.session['test_phase_flag'] == True and request.session['test_iteration']>3:
            return render(request,"Questionnaire_type2/break_to_features.html")
...
def fixature_screen_test_type3(request):
    return render(request,"Questionnaire_type2/fixature_screen_test.html")
...
def common_features_test_block_display_stimuli_type3(request):
    if request.method=="POST":
        ...
        if request.session['setnumber'] == 0:
            ...
            common_feature.file_name = "NoColorCue_type3/set0" + request.session['file_name']
        elif request.session['setnumber'] == 1:
            ...
            common_feature.file_name = "NoColorCue_type3/set1" + request.session['file_name']
        elif request.session['setnumber'] == 2:
            ...
            common_feature.file_name = "NoColorCue_type3/set2" + request.session['file_name']
        elif request.session['setnumber'] == 3:
            ...
            common_feature.file_name = "NoColorCue_type3/set3" + request.session['file_name']
        elif request.session['setnumber'] == 4:
            ...
            common_feature.file_name = "NoColorCue_type3/set4" + request.session['file_name']
