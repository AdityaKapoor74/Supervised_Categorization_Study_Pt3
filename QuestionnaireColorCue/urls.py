...
urlpatterns = [
    path('set<int:num>/', views.register, name='register_type2'),
    path('contact/', views.contact, name='contact_type2'),
    path('about/', views.about, name='about_type2'),
    path("terms/", views.terms, name='terms_type2'),
    ...
    path("description/", views.save_responses_description, name='save_responses_description_type2'),
